...
describe('Vuex - Pruebas en el Journal Module', () => {
  ...
  test('getters: getEntriesByTerm - getEntryById', () => {
    ...
    expect( store.getters['journal/getEntriesByTerm']('YO') ).toEqual([ entry2 ])

    expect( store.getters['journal/getEntryById']('-NABKuq_QjuYAu8W945Y') ).toEqual( entry1 )
  ...
  test('actions: updateEntry', async() => {
    ...
    const updateEntry = {
      id: '-NABKuq_QjuYAu8W945Y',
      date: 1661285666876,
      picture: 'https://res.cloudinary.com/dceymlais/image/upload/v1661286567/rgpremg96cskzlseqwna.jpg',
      text: 'Hola mundo'
    }
